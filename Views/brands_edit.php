...
<section class="content-header">
    ...
    <section class="content container-fluid">
        <form action="<?php echo BASE_URL."brands/edit_action/".$info['id']?>" method="POST">
            <div class="box">
        	    ...
        	    <div class="box-body">
        		    <div class="form-group <?php echo (in_array('brand', $errorItems))?'has-error':'';?>">
                        ...
                        <input type="text" name="brand" class="form-control" id="brand_name" value="<?php echo $info['name'];?>">
