...
<section class="content-header">
    ...
    <section class="content container-fluid">
        <form method="POST" action="<?php echo BASE_URL; ?>fornecedores/edit_action/<?php echo $info['id']; ?>">
            <div class="box">
        	    ...
        	    <div class="box-body">
                    ...
                    <div class="form-group <?php echo (in_array('inscricao', $errorItems))?'has-error':'';?>">
                        ...
                        <input type="text" name="inscricao" data-mask="000.000.000" data-mask-selectonfocus="true" value="<?php echo $info['inscricao']; ?>"  class="form-control" id="inscricao_name">
                        <span class="help-block" id="indisponivel" <?php echo (in_array('fornecedores', $errorItems))?'style="display:block;"':'style="display:none;';?>><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Preencha este campo!</font></font></span>
                    </div>
        		    ...
        		    <div class="form-group <?php echo (in_array('telefone', $errorItems))?'has-error':'';?>">
                        ...
                        <input type="text" name="telefone" data-mask="(00) 0000-0000" data-mask-selectonfocus="true" value="<?php echo $info['telefone']; ?>"  class="form-control" id="telefone_name">
                        <span class="help-block" id="indisponivel" <?php echo (in_array('fornecedores', $errorItems))?'style="display:block;"':'style="display:none;';?>><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Preencha este campo!</font></font></span>
                    </div>

                    <div class="form-group <?php echo (in_array('celular', $errorItems))?'has-error':'';?>">
                        <label for="celular_name">Celular</label>
                        <input type="text" name="celular" data-mask="(00) 00000-0000" data-mask-selectonfocus="true" value="<?php echo $info['celular']; ?>" class="form-control" id="celular_name">
                    </div>
