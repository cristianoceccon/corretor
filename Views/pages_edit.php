...
<section class="content-header">
    ...
    <section class="content container-fluid">
        <form action="<?php echo BASE_URL."pages/edit_action/".$list_page['id'].""?>" method="POST">
            <div class="box">
        	    ...
        	    <div class="box-body">
        		    <div class="form-group <?php echo (in_array('title', $errorItems))?'has-error':'';?>">
                        ...
                        <input type="text" name="title" class="form-control" id="page_title" value="<?php 
                        echo $list_page['title'];?>">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="page_body" name="body" ><?php 
                        $body = str_replace("../../media/pages/", "".BASE_URL_SITE."media/pages/", $list_page['body']);
