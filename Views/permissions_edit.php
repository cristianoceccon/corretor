...
<section class="content-header">
    ...
    <section class="content container-fluid">
        <form action="<?php echo BASE_URL."permissions/edit_action/".$permissions_id.""?>" method="POST">
            <div class="box">
        	    ...
        	    <div class="box-body">
        		    <div class="form-group <?php echo (in_array('name', $errorItems))?'has-error':'';?>">
                        ...
                        <input type="text" name="name" class="form-control" id="group_name" value="<?php echo $permissions_name_group;?>">
                                ...
                                <?php foreach($permissions_item as $p){?>
                                    <?php if($p['id_items_group'] === $item['id']){?>
                                        <div class="form-group" style="float:left;margin-left:10px;">
                                            <input type="checkbox" name="items[]" value="<?php echo $p['id'];?>" id="item-<?php echo $p['id'];?>" <?php echo (in_array($p['slug'], $permissions_link_group))?'checked="checked"':'';?>>
