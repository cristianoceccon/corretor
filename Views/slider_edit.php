...
<section class="content-header">
    ...
    <section class="content container-fluid">
        <form  method="POST" action="<?php echo BASE_URL."sliders/edit_action/".$info['id'];?>" enctype="multipart/form-data">
            <div class="box">
        	    ...
        	    <div class="box-body">
                    ...
                    >
                        ...
                        <select name="locality" class="form-control" id="slide_locality" required>
                            <option value="1" <?php echo($info['locality'] == 1)?'selected':'';?>>Página Inicial Topo</option>
                            <option value="3" <?php echo($info['locality'] == 3)?'selected':'';?>>Página de Categoria</option>
                        </select>
                    ...
                    <div class="form-group <?php echo (in_array('status', $errorItems))?'has-error':'';?>">
                        ...
                        <select name="status" class="form-control" id="slide_status" required>
                            <option value="ATIVO" <?php echo($info['status'] == 'ATIVO')?'selected':'';?>>ATIVO</option>
                            <option value="INATIVO" <?php echo($info['status'] == 'INATIVO')?'selected':'';?>>INATIVO</option>
                        </select>
                    </div>

                    <div class="form-group <?php echo (in_array('id_category', $errorItems))?'has-error':'';?>" id="display_id_category" <?php echo (!empty($info['id_category']))?'style="display:block;"':'style="display:none;"';?>>
                    ...
                    <div class="form-group <?php echo (in_array('link', $errorItems))?'has-error':'';?>">
                        ...
                        <input type="text" name="link" value="<?php echo $info['link'];?>" class="form-control" id="slide_link" placeholder="Ex: https://www.facebook.com.br/arte_borda"/>
