...
<section class="content-header">
    ...
    <section class="content container-fluid">
        <form method="POST" action="<?php echo BASE_URL; ?>cheques/baixar_action/<?php echo $info['id']; ?>">
            <div class="box">
        	    <div class="box-header">
        		    <h3 class="box-title">Baixar Cheque</h3>
        		    <div class="box-tools">
                ...
                <div class="form-group <?php echo (in_array('data_baixa', $errorItems))?'has-error':'';?>">
                        <label for="data_baixa_name">Data da Baixa</label>
                        <input type="date" name="data_baixa" value="<?php echo $info['data_baixa']; ?>" class="form-control" id="data_baixa_name" required>
                    </div>
                ...
                <div class="form-group <?php echo (in_array('id_conta_banco', $errorItems))?'has-error':'';?>">
                        <label for="form_id_conta_banco">Banco</label>
                            <select required name="id_conta_banco" class="form-control select2" id="id_conta_banco_name">
                        ...
                        <label for="form_id_conta_numero">Conta</label>
                            <select required name="id_conta_numero" class="form-control select2" id="id_conta_numero_name">
                                <?php foreach($con_list as $item): ?>
                    ...
                    <div class="form-group <?php echo (in_array('id_fornecedor', $errorItems))?'has-error':'';?>">
                        <label for="form_id_fornecedor">Emissor</label>
                            <select required name="id_fornecedor" class="form-control select2" id="id_fornecedor_name">
