                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <a href="<?php echo BASE_URL."brands/del/".$item['id']?>" class="btn btn-xs btn-danger <?php echo ($item['b'] > 0)?'disabled':'';?>"  onclick="return confirm('Tem certeza que deseja excluir ?')" >Excluir</a>
                                </div>
                            </td>
                        </tr>
                    <?php }?>
