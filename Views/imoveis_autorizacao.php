...
<div class="tab-pane active" id="detalhes_pedido">
    <section class="invoice" style="margin:0px;">
        ...
        <div class="row">
            ...
            <br>    <!-- /.col -->
            Eu, <?php echo $info['user']['nome']?>, inscrito no CPF sob o nº </strong><?php echo $info['user']['cpf']?>, RG </strong><?php echo $info['user']['rg']?>, 
            residente e domiciliado na <?php echo $info['user']['endereco']?>, <?php echo $info['user']['numero_end']?>, 
