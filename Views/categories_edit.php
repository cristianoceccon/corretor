...
<section class="content-header">
    ...
    <section class="content container-fluid">
        <form action="<?php echo BASE_URL."categories/edit_action/"?><?php echo $id_cat;?>" method="POST">
            <div class="box">
        	    ...
        	    <div class="box-body">
        		    <div class="form-group <?php echo (in_array('name', $errorItems))?'has-error':'';?>">
                        ...
                        <input type="text" name="name" class="form-control" id="group_name" value="<?php echo $value_cat['name'];?>">
